...
export const TOP_ACTIVITIES: TopActivities[] = [
  {
    ...
    title: "Jeep Safari",
    headline: "Conquer the Rugged Mountains in Style",
    description:
...

  {
    ...
    destinationId: DESTINATION_IDS.SKARDU,
    title: "Paragliding",
    headline: "Soar Above Peaks and Valleys",
    description:
...

  {
    ...
    destinationId: DESTINATION_IDS.SKARDU,
    title: "Boating",
    headline: "Sail Through Silence & Serenity",
    description:
...

  {
    ...
    destinationId: DESTINATION_IDS.SKARDU,
    title: "Sightseeing",
    headline: "Discover the Heritage and Natural Wonders",
    description:
...
export const TOP_TOURIST_ATTRACTIONS: TopTouristAttractions[] = [
  {
    ...
    headline: "Nature’s Mirror in the Heart of Skardu",
    description:
...

  {
    ...
    headline: "A Hidden Gem Above the Valley",
    description:
...

  {
    ...
    destinationId: DESTINATION_IDS.SKARDU,
    title: "Shigar Valley",
    headline: "Gateway to the Karakoram Majesty",
    description:
...

  {
    ...
    destinationId: DESTINATION_IDS.SKARDU,
    title: "Satpara Dam",
    headline: "Tranquility Amidst Rugged Peaks",
    description:
...

  {
    ...
    headline: "The Land of Giants and Wild Wonders",
    description:
...

  {
    ...
    destinationId: DESTINATION_IDS.SKARDU,
    title: "Khaplu Fort",
    headline: "Step into a Timeless Balti Palace",
    description:
